import { InternalLink, Title } from '../components/DesignSystem';
  ...
  return (
    <Layout browserTitle='Home' description='Home'>
      <div className='my-16 space-y-10 sm:space-y-3 '>
        ...
        <div className='-mx-4 text-5xl font-bold tracking-tight text-center text-gray-800 sm:text-6xl md:text-8xl sm:w-3/4 sm:text-left sm:-mx-0'>
          We make a fast and beautiful website
        </div>
        <div className='flex justify-center sm:justify-start'>
          <Link href='/showcase'>
            <a className='flex items-center space-x-2 text-2xl text-blue-600 cursor-pointer sm:text-xl hover:underline'>
              Showcase
              <svg
